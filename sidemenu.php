<a href="index.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Franchise Admin</a>
        </div>
      </div>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
			 <!--li class="nav-item">
			  ...
			  <li class="nav-item">
                <a href="add_country_franchise.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Country Franchise</p>
                </a>
              </li-->
			  <!--li class="nav-item">
   ...
   <!--           </li>-->
		  ...
		  <!--li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
			 <li class="nav-item">
                <a href="continent_franchise_view.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>continent franchise</p>
                </a>
              </li>
			 <li class="nav-item">
                <a href="cf_view.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>cf</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="ccf_view.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ccf</p>
                </a>
              </li>
			    <li class="nav-item">
                <a href="csf_view.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>csf</p>
                </a>
              </li>
			    <li class="nav-item">
                <a href="crf_view.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>crf</p>
                </a>
              </li>
